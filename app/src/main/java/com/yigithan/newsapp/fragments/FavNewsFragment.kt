...
import kotlinx.android.synthetic.main.fragment_fav_news.*
import kotlinx.android.synthetic.main.fragment_search_news.*

class FavNewsFragment : Fragment(R.layout.fragment_fav_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(R.id.action_favNewsFragment_to_detailNewsFragment2, bundle)
        }
